...
import {
  ...
  FiChevronRight, FiArrowRight, FiUser, FiX,
} from 'react-icons/fi'
...
export default function DashboardSidebar() {
  ...
  // Dismissible "Upgrade to Care+" card — persists across navigation and reloads.
  const [showUpgrade, setShowUpgrade] = useState(
    () => typeof window === 'undefined' || localStorage.getItem('ss_hide_upgrade') !== '1'
  )
  const dismissUpgrade = () => {
    setShowUpgrade(false)
    try { localStorage.setItem('ss_hide_upgrade', '1') } catch { /* ignore */ }
  }
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="absolute top-2.5 right-2.5 z-10 w-6 h-6 rounded-full flex items-center justify-center bg-white/15 hover:bg-white/30 transition-colors"
                style={{ color: '#ffffff' }}
              >
                <FiX size={13} />
              </button>
              <div className="relative flex items-center gap-2 mb-2 pr-7">
